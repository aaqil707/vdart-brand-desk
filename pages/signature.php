...
document.head.appendChild(deleteButtonStyles);
                    ...
                    <div class="form-group">
                        ...
                        <small id="email-error" style="color: red; display: none;">Email must end with @vdartinc.com</small>
                    </div>
                    ...
                    <script>
                        document.getElementById("email").addEventListener("input", function() {
                            ...
                            if (!email.endsWith("@vdartinc.com")) {
                                errorMsg.style.display = "block"; // Show error message
                                this.setCustomValidity("Email must end with @vdartinc.com"); // Prevent form submission
                            } else {
        ...
        <table cellpadding="0" cellspacing="0" style="width: 330px; border-collapse: collapse; margin: 0; padding: 0;">
                        ...
                        <tr>
                            ...
                            <td width="80" valign="top" style="padding-right: 20px; border: none;">
                                ...
                                <a  target="_blank" style="border: none; text-decoration: none;">
                                    <img src="images/logo1 (1).png" alt="VDart" width="90" style="display: block; max-width: 110px; height: auto; border: none;">
                                </a>
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 330px; border-collapse: collapse; margin: 0;">
                        ...
                        <tr>
                            ...
                            <td style="padding: 2px 0 0 0; border: none;"> 
                                ...
                                <img src="images/greatplacebanner.jpg" alt="Largest staffing Firms in the US" width="330" style="display: block; border: none;">
            ...
            <tr>
                <td style="padding-bottom: 8px; border: none; text-align: center; border-collapse: collapse;">
                    ...
                    | 
                    <a href="https://www.vdart.com/what-we-do/media/" style="color: #0066cc; text-decoration: none; font-size: 10px; border: none; border-collapse: collapse;">
        ...
        <div style="font-family: 'Montserrat', Arial, sans-serif !important; font-size: 12px !important; color: #000000 !important; line-height: 1.2 !important; max-width: 600px !important; margin: 0 !important; padding: 0 !important;">
            ...
            <tr>
                <td style="padding-top: 8px; border: none !important; text-align: center;">
                    ...
                    <a href="https://www.vdart.com/what-we-do/media/" style="color: #0066cc !important; text-decoration: none !important; font-size: 10px !important; font-family: 'Montserrat', Arial, sans-serif !important;">
                        Want to know more About Us?
                    </a>
                </td>
            </tr>
                            ...
                            <tr>
                                <td width="80" valign="top" style="padding-right: 20px; border: none !important;">
                                    <a  target="_blank" style="border: none !important; text-decoration: none !important;">
                                        <img src="http://vdpl.co/dnimg/vdartlogo.png" alt="Trust People" width="90" style="display: block !important; max-width: 110px !important; height: auto !important; border: none !important;">
                                    </a>
                                </td>
                                <td valign="top" style="border: none !important;">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" style="max-width: 100%; border-collapse: collapse !important;">
                            ...
                            <tr>
                                <td style="padding: 5px 0 0 0 !important; border: none !important;">
                                    <img src="http://vdpl.co/dnimg/greatplacebanner.jpg" alt="Largest staffing Firms in the US" width="100%" style="display: block !important; border: none !important; max-width: 330px; height: auto;">
                                </td>
                            </tr>
                        </table>
                    </td>
