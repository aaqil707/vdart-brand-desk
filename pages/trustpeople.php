...
document.head.appendChild(deleteButtonStyles);
                    ...
                    <div class="form-group">
                        ...
                        <small id="email-error" style="color: red; display: none;">Email must end with @trustpeople.com</small>
                    </div>
                    ...
                    <script>
                        document.getElementById("email").addEventListener("input", function() {
                            ...
                            if (!email.endsWith("@trustpeople.com")) {
                                errorMsg.style.display = "block"; // Show error message
                                this.setCustomValidity("Email must end with @trustpeople.com"); // Prevent form submission
                            } else {
...
<script>
        ...
        // Update preview as user types if auto-refresh is enabled
                    ...
                    <tr>
                        ...
                        <td width="80" valign="top" style="padding-right: 20px; border: none;">
                            ...
                            <a  target="_blank" style="border: none; text-decoration: none;">
                                <img src="images/Trustpeople (1).png" alt="VDart" width="90" style="display: block; max-width: 110px; height: auto; border: none;">
                            </a>
                ...
                <table cellpadding="0" cellspacing="0" style="width: 330px; border-collapse: collapse; margin: 0;">
                    ...
                    <tr>
                        ...
                        <td style="padding: 2px 0 0 0; border: none;"> 
                            ...
                            <img src="images/Trustpeople Final (2).png" alt="Largest staffing Firms in the US" width="330" style="display: block; border: none;">
                        ...
                        <tr>
                            <td width="80" valign="top" style="padding-right: 20px; border: none !important;">
                                <a  target="_blank" style="border: none !important; text-decoration: none !important;">
                                    <img src="http://vdpl.co/dnimg/trustpeople.png" alt="Trust People" width="90" style="display: block !important; max-width: 110px !important; height: auto !important; border: none !important;">
                                </a>
                            </td>
                            <td valign="top" style="border: none !important;">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" style="max-width: 100%; border-collapse: collapse !important;">
                        ...
                        <tr>
                            <td style="padding: 5px 0 0 0 !important; border: none !important;">
                                <img src="http://vdpl.co/dnimg/trustpeoplefinal.png" alt="Largest staffing Firms in the US" width="100%" style="display: block !important; border: none !important; max-width: 330px; height: auto;">
                            </td>
                        </tr>
                    </table>
                </td>
